...
const Navbar: React.FC<NavbarProps> = ({ profilePicUrl }) => {
  ...
  return (
    <div className="w-full mx-4 h-20 flex justify-between items-center">
      <div className="flex items-center">
        <FaHandshake className="w-8 h-8 text-yellow-500 hover:text-yellow-400 mr-2" />
        <Link
          to="/"
          className="text-2xl text-yellow-500 hover:text-yellow-400 font-bold"
        >
          Makaan
        </Link>
      </div>

      <ul className=" hidden md:flex items-center justify-between text-base">
        ...
        <li className="p-4">
          <Menu as="div" className="relative inline-block text-left">
            {({ open }) => (
              <>
                <Menu.Button className="hover:text-yellow-500 text-black text-sm focus:text-yellow-500 flex px-4 py-2">
                  REAL ESTATE
                      ...
                      {({ active }) => (
                        <Link
                          ...
                          className={classnames(
                            active ? "text-yellow-500" : "text-black text-sm",
        ...
        <li className="p-4">
          <Menu as="div" className="relative inline-block text-left">
            {({ open }) => (
              <>
                <Menu.Button className="hover:text-yellow-500 text-sm text-black focus:text-yellow-500 flex px-4 py-2">
                  VEHICULE
                  <span className="ml-2 pt-1">
                    {open ? <FaChevronUp /> : <FaChevronDown />}
                  </span>
        ...
        <li className="p-4">
          <Link
            to="/addProperty"
            className="hover:text-yellow-500 text-black text-sm focus:text-yellow-500 flex px-4 py-2"
          >
            ADD PROPERTY
          </Link>
        </li>
